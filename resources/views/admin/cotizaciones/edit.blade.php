    ...
    <div class="section-header bg-white border rounded shadow-sm px-4 py-3 d-block">
        ...
        <div class="row align-items-end">
            ...
            <div class="col-lg-2 col-md-3">
                <label for="estatus" class="font-weight-semibold mb-2">Estatus</label>
                <select name="estatus" id="estatus" class="form-control" required form="cotizacion-form">
                    <option value="solicitada" {{ old('estatus', $cotizacion->estatus) === 'solicitada' ? 'selected' : '' }}>Solicitada</option>
                    <option value="aceptada" {{ old('estatus', $cotizacion->estatus) === 'aceptada' ? 'selected' : '' }}>Aceptada</option>
                    <option value="completada" {{ old('estatus', $cotizacion->estatus) === 'completada' ? 'selected' : '' }}>Completada</option>
                    <option value="cancelada" {{ old('estatus', $cotizacion->estatus) === 'cancelada' ? 'selected' : '' }}>Cancelada</option>
